...
?>
     ...
     <?php
		...
		$sql1="select id,((`Conservative Dentistry`*2)+(`Oral Surgery`*2)+(`Periodontics`*2)+(`Prosthodontics`*2)+(`Oral Pathology`*2)+(`Orthodontics`*2)+
		(`Dental Imaging and Radiology`*2)+(`Community Dentistry`*2))/8 as 'a',name from forth order by a DESC";
...
<p style="text-align: center; font-size: 24px; font-weight: bold;">
  <h2>
	  <h2><div align="center"> ڕیزبه‌ندی قۆناغی چواره‌م </div></h2>
</p>
<table align="center">
  <thead>
      <tr>
