...
?>
     ...
     <?php
		...
		$sql1="select id,((`Oral Surgery`*8)+(`Conservative`*8)+(`Prosthodontics`*6)+(`Orthodontics`*6)+(`Periodontics`*8)+(`Oral Medicine`*4)+(`Pedodontics`*4)+
		(`Prevention`*2)+(`Research Methodology`*4))/50 as a,name from fifthstage order by a DESC";
...
<p style="text-align: center; font-size: 24px; font-weight: bold;">
  <h2>
	  <h2><div align="center"> ڕیزبه‌ندی قۆناغی پێنجه‌م </div></h2>
</p>
<table align="center">
  <thead>
      <tr>
