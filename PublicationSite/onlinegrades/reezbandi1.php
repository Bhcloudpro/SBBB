...
?>
     ...
     <?php
		...
		$sql1="select id,((`Dental Anatomy`*2)+(`Clinical Oriented Anatomy`*2)+(`Physics`*2)+(`Chemistry`*2)+(`Computer`*2)+(`Biology`*2)+(`Terminology`*2)+(`Kurdology`*2))/8 as 'a',name from firststage order by a DESC";
...
<p style="text-align: center; font-size: 24px; font-weight: bold;">
  <h2>
	  <h2><div align="center"> ڕیزبه‌ندی قۆناغی یه‌ك </div></h2>
</p>
<table align="center">
  <thead>
      <tr>
