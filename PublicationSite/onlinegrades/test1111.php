...
?>
	...
	$stage1=$_POST['stage'];
		...
		$sql1="select * from $stage1  where  id="."'$studentid'";
...
<input type="button"  value="Save as PDF" onClick="forprint()">
...
<form id="form1" method="post" action="tana.php">
  ...
  <p>
    <input type="submit" id="codes1" value="تانه وه‌رگرتن"/>
  </p>
</form>
...
<?php
  ...
  <table align="center">
	...
	if(($row1[9]<50)or($row1[8]<50)or($row1[7]<50)or($row1[6]<50)or($row1[5]<50)or($row1[4]<50)
	  ($row1[3]<50)or($row1[2]<50)){
