...
?>
	...
	$stage1=$_GET['stage'];
		...
		$sql1="select * from secondstages  where  id="."'$studentid'";
...
<form id="form1" method="post" action="tana.php">
  ...
  <p>
    <input type="submit" id="codes1" value=" کلیك بکه بۆ تانه وه‌رگرتن" style="height: 50px; width: 200px; text-emphasis-color:black; background-color:brown; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'; font-size: 15pt"/>
  </p>
</form>
	</div>
<h2><div align="center"> نمره‌ی تاقیکردنه‌وه‌کانی کۆتایی ساڵ- قۆناغی<?=" ".$stage;?></div></h2>
<?php
    ...
    <tbody>
	  ...
	  <tr>
        ...
        <td colspan="1"></td>
	  	  ...
	  	  <tr>
        <td>COD24</td>
        <td colspan="2">Oral Histology</td>
        <td colspan="1">
        ...
        <td colspan="1"></td>
	 	  ...
	 	  <tr>
        <td>COD25</td>
        <td colspan="2">General Histology</td>
	            <td colspan="1">
			 ...
			 <?php 
				 ...
				 elseif((round($row1[6],1)<=59) and (round($row1[6],1)>=50)){echo "په‌سه‌ند";}
				 elseif($row1[6]=="nill"){echo "";}
				 else {echo "<b><font color='red'><u>که‌وتوو</u></font></b>";}
			?>
	  ...
	  <tr>
        <td>COD26</td>
        <td colspan="2">Dental Material</td>
        <td colspan="1">
