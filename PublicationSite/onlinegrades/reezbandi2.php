...
?>
     ...
     <?php
		...
		$sql1="select id,((`Biochemistry`*2)+(`Human Anatomy`*2)+(`General Histology`*2)+
		(`Physiology`*2)+(`Prosthodontics`*2)+(`Dental Material`*2)+(`Terminology`*2)+
		(`Oral Histology`*2))/7 as 'a',name from secondstage order by a DESC";
...
<p style="text-align: center; font-size: 24px; font-weight: bold;">
  <h2>
	  <h2><div align="center"> ڕیزبه‌ندی قۆناغی دووه‌م </div></h2>
</p>
<table align="center">
  <thead>
      <tr>
