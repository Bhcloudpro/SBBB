...
?>
     ...
     <?php
		...
		$sql1="select * from thirdstages  where  id="."'$studentid'";
...
<?php
  ...
  <table align="center">
    ...
    <tbody>
      <tr>
        <td>COD31</td>
        <td colspan="2">General Medicine</td>
		<td colspan="1">
			 <?php 
	  ...
	  <tr>
        ...
        <td colspan="1"></td>
	  	  ...
	  	  <tr>
        <td>COD34</td>
        <td colspan="2">Conservative Dentistry</td>
        <td colspan="1">
	  ...
	  <tr>
        <td>COD36</td>
        <td colspan="2">Community Medicine</td>
        <td colspan="1">
	  ...
	  <tr>
        <td>COD37</td>
        <td colspan="2">General Pathology</td>
        <td colspan="1">
